...
// send-critical state.json): a private (0700, symlink/owner-guarded) dir, a target
// checked regular/owned/unlinked, then an unpredictable temp created exclusively
// (flag 'wx' — never follows or reuses a pre-planted temp) and atomically renamed
// into place, with the temp always cleaned up. Concurrent readers see whole-old or
// whole-new content, never a torn write.
export function atomicWriteFile(dir, name, contents) {
